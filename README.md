...
- **Design assurance review.** All clusters should do this for themselves, but the App team can help you set the process up.



## Common topics

The topics listed below are based on the questions that teams always ask. There won't be easy or perfect answers for all of them, but this section will attempt to sketch out the pieces and describe gaps. Think of this as an alternative table of contents, organised by things you might ask rather than by category of information.
